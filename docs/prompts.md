...
This documentation provides an overview of the structure of a json file used as a prompt to interface with ChatGPT via the Python API. The json file contains settings and parameters that customize the behavior and functionality of the prompt. Below is an explanation of each field and its purpose:
...
### `gptModel`
- Type: String
- Description: Specifies the version or model of ChatGPT to be used for generating responses.
